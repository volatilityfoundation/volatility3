...
class queue_entry(objects.Struct):
    def walk_list(self, list_head, member_name, type_name, max_size = 4096):
        yielded = 0
...
class sockaddr_dl(objects.Struct):
    def __str__(self):
        ret = ""
