...
class Intel32e5(Intel):
    ...
    _maxphyaddr = 52
    _maxvirtaddr = 57
    _structure = [('page map layer 5', 9, False), ('page map layer 4', 9, False), ('page directory pointer', 9, True),
                  ('page directory', 9, True), ('page table', 9, True)]
