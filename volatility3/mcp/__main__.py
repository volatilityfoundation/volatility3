"""Entry point for running the Volatility3 MCP server."""
...
def main(argv: list[str] | None = None) -> None:
    """Entry point for running the Volatility3 MCP server."""
    parser = argparse.ArgumentParser(description="Volatility3 MCP Server - Memory forensics via Model Context Protocol")
    parser.add_argument(
        "--transport",
    ...
    # Suppress verbose volatility3 logging unless DEBUG
