    ...
    def get_requirements(cls) -> List[interfaces.configuration.RequirementInterface]:
        ...
        vmayarascan_requirements = [
            ...
            requirements.PluginRequirement(
                name="pslist", plugin=pslist.PsList, version=(4, 0, 1)
            ),
            requirements.PluginRequirement(
                name="yarascan", plugin=yarascan.YaraScan, version=(2, 0, 1)
            ),
            requirements.PluginRequirement(
                name="yarascanner", plugin=yarascan.YaraScanner, version=(2, 1, 1)
            ),
